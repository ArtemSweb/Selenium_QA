...
try: 
    ...
    inputFirstName = browser.find_element_by_xpath('//label[contains(text(),"First")]/following-sibling::input')
    inputFirstName.send_keys("Artem")

    inputSecondName = browser.find_element_by_xpath('//label[contains(text(),"Last")]/following-sibling::input')
